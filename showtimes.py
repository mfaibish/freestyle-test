...
def time_format(x): # Time converstion to 12 hour (https://stackoverflow.com/questions/13855111/how-can-i-convert-24-hour-time-to-12-hour-time)
    t = datetime.datetime.strptime(x, "%H:%M")
